...
module.exports = {
  ...
  Mutation: {
    ...
    addPlayerToTournament: async (obj, args, context) => {
      ...
      const userDoc = await context.loaders.users.findOneCachedById(
        args.memberId
      );
      ...
      return context.loaders.tournaments.findOneCachedById(args.id);
    },
    ...
    startTournament: async (obj, args, context) => {
      const doc = await context.loaders.tournaments.findOneCachedById(args.id);
